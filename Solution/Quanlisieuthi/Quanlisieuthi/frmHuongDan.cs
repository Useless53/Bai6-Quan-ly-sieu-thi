...
namespace Quanlisieuthi
{
    public partial class frmHuongDan : Form
    {
        ...
        private void treeView1_AfterSelect(object sender, TreeViewEventArgs e)
        {
            ...
            {
                txtHD.Text = @"Để tìm kiếm nội dung nào đó, bạn nhập thông tin vào ô trống trong phần tìm kiếm sau đó click vào ô 'Tìm kiếm' tìm kiếm ở đây là tìm kiếm theo ID của nội dung đó hoặc tên của nội dung đó";
            }
        }
