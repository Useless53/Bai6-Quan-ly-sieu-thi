    ...
    public partial class frmKhachHang : Form
    {
        ...
        private void but_Up_Click(object sender, EventArgs e)
        {
            ...
            if (check > 0)
            {
                ...
                conn.KhoiTao(dataGridView2, @"select * from dbo.KhachHang");
        ...
        private void but_Del_Click(object sender, EventArgs e)
        {
            if (MessageBox.Show("Bạn có muốn xóa không?", "Thông báo", MessageBoxButtons.OKCancel, MessageBoxIcon.Warning) == DialogResult.OK)
            {
                ...
                if (check > 0)
                {
                    ...
                    conn.KhoiTao(dataGridView2, @"select * from KhachHang");
        ...
        private void but_Find_Click(object sender, EventArgs e)
        {
            ...
            if (dataGridView2.RowCount <= 0) MessageBox.Show("Nội dung cần tìm không có");
        ...
        {
            conn.KhoiTao(dataGridView2, constr);
        }
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            {
                txtID.Text = Convert.ToString(dataGridView2.CurrentRow.Cells[0].Value);
                txtTen.Text = Convert.ToString(dataGridView2.CurrentRow.Cells[1].Value);
                txtSDT.Text = Convert.ToString(dataGridView2.CurrentRow.Cells[2].Value);
                txtGT.Text = Convert.ToString(dataGridView2.CurrentRow.Cells[3].Value);
            }
            else
            {
                return;
